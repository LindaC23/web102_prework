...
const displayStrMany = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently, ${totalUnfunded} games remain unfunded. We need your help to fund these amazing games!`
const displayStrOne = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently, ${totalUnfunded} game remains unfunded. We need your help to fund these amazing games!`
const displayStr = (totalUnfunded == 1) ? displayStrOne  : displayStrMany;
